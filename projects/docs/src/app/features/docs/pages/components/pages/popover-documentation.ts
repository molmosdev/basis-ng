...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col gap-4">
      <span>
        Popover is a floating panel positioned relative to a trigger. It uses CSS Anchor Positioning
        for layout and supports click or hover triggers with fully custom content.
      </span>
        ...
        <table class="table-auto w-full text-left text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td class="border-t border-gray-200 dark:border-neutral-900 px-4 py-2">
      ...
      >
        <b-popover>
          <button b-button class="b-variant-outlined" bPopoverTrigger mode="hover">Hover me</button>
          <ng-template #popoverContent>
      ...
      >
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>Top</button>
          <ng-template #popoverContent>
            <b-popover-content position="top">
        ...
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>Bottom</button>
          <ng-template #popoverContent>
            <b-popover-content position="bottom">
        ...
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>Left</button>
          <ng-template #popoverContent>
        ...
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>Right</button>
          <ng-template #popoverContent>
        ...
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>Top left</button>
          <ng-template #popoverContent>
        ...
        <b-popover>
          <button b-button class="b-variant-outlined" mode="hover" bPopoverTrigger>
            Top right
          </button>
          <ng-template #popoverContent>
      ...
      <div
        class="border border-gray-200 dark:border-neutral-900 rounded-lg p-6 mb-6 flex flex-col items-center justify-center gap-4"
      >
        <b-popover [hasBackdrop]="true" [trapFocus]="true" [autoFocus]="true" [restoreFocus]="true">
            ...
            <ng-template #popoverContent>
              <b-popover-content position="bottom">
                <b-card class="w-[280px]">
                  ...
                  <b-card-content>
                    <p class="text-sm">Open, close, or click the backdrop to see events.</p>
                  </b-card-content>
                </b-card>
              </b-popover-content>
            </ng-template>
