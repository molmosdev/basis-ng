...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col gap-4">
      ...
      >
        <b-tooltip>
          <span bTooltipTrigger bOverlayOrigin #triggerSm="bOverlayOrigin" class="cursor-pointer">
            Small
          </span>
        ...
        <b-tooltip>
          <span bTooltipTrigger bOverlayOrigin #triggerMd="bOverlayOrigin" class="cursor-pointer">
            Medium
          </span>
        ...
        <b-tooltip>
          <span bTooltipTrigger bOverlayOrigin #triggerLg="bOverlayOrigin" class="cursor-pointer">
            Large
          </span>
      ...
      >
        <b-tooltip>
          <button b-button bTooltipTrigger bOverlayOrigin #triggerButton="bOverlayOrigin">
            Get started
          </button>
          <ng-template
            bConnectedOverlay
      ...
      >
        ...
        <b-tooltip>
          ...
          <ng-template bConnectedOverlay [trigger]="triggerTopCenter" [positions]="['top-center']">
        ...
        <b-tooltip>
          ...
          <ng-template bConnectedOverlay [trigger]="triggerLeftTop" [positions]="['left-top']">
        ...
        <b-tooltip>
          ...
          <ng-template bConnectedOverlay [trigger]="triggerRightTop" [positions]="['right-top']">
