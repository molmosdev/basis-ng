...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col gap-4">
      <span>Card is a flexible container for grouping related content and actions.</span>
      ...
      >
        <b-card class="w-full max-w-[400px]">
          ...
          <b-card-content>
            Here is some content inside the card. This is a longer text to demonstrate how the card
            handles multiple lines of content. You can add as much information as needed, and the
            card will expand accordingly to fit the content.
          </b-card-content>
          <b-card-footer>
      ...
      >
        <b-card class="w-full max-w-[350px]">
          <b-card-header>
            ...
            <b-card-description>Enter your credentials to continue.</b-card-description>
          </b-card-header>
          <b-card-content>
