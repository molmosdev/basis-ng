...
import { Alert, Button, Spinner } from '@basis-ng/primitives';
...
@Component({
  ...
  template: `
    <app-steps-buttons
      [previous]="{ label: 'Skeleton', path: '/docs/components/skeleton' }"
    ...
    <div class="flex flex-col gap-4">
      <span>
        Spinner is a loading indicator component. It supports three sizes and two visual types for
        flexible use in buttons or as a standalone indicator.
        <br />
      </span>
      <code-block [code]="angularImport" />
      <span>
        Include the styles for the spinner. The component is headless without them.
        <br />
      </span>
