...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col gap-4">
      <span
        >Input Group allows you to group one or more <code>b-input</code> elements together with
        additional elements such as text or buttons, before or after the input.</span
      >
